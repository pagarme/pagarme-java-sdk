...
public final class DefaultInvoicesController extends BaseController implements InvoicesController {
     ...
     * @return    Returns the GetInvoiceResponse response from the API call
     */
    public CompletableFuture<GetInvoiceResponse> updateInvoiceMetadataAsync(
            final String invoiceId,
            final UpdateMetadataRequest request,
            final String idempotencyKey) {
        try {
            return prepareUpdateInvoiceMetadataRequest(invoiceId, request, idempotencyKey).executeAsync();
        } catch (Exception e) {
     ...
     * @return    Returns the GetInvoiceResponse response from the API call
     */
    public CompletableFuture<GetInvoiceResponse> getPartialInvoiceAsync(
            final String subscriptionId) {
        try {
            return prepareGetPartialInvoiceRequest(subscriptionId).executeAsync();
        } catch (Exception e) {
            throw new CompletionException(e);
        }
    }
     ...
     * @return    Returns the GetInvoiceResponse response from the API call
     */
    public CompletableFuture<GetInvoiceResponse> cancelInvoiceAsync(
            final String invoiceId,
            final String idempotencyKey) {
        try {
            return prepareCancelInvoiceRequest(invoiceId, idempotencyKey).executeAsync();
        } catch (Exception e) {
            throw new CompletionException(e);
        }
    }
     ...
     * @return    Returns the GetInvoiceResponse response from the API call
     */
    public CompletableFuture<GetInvoiceResponse> createInvoiceAsync(
            final String subscriptionId,
            final String cycleId,
            final CreateInvoiceRequest request,
            final String idempotencyKey) {
     ...
     * @return    Returns the ListInvoicesResponse response from the API call
     */
    public CompletableFuture<ListInvoicesResponse> getInvoicesAsync(
            final Integer page,
            final Integer size,
            final String code,
            final String customerId,
        ...
        try {
            return prepareGetInvoicesRequest(page, size, code, customerId, subscriptionId, createdSince,
            createdUntil, status, dueSince, dueUntil, customerDocument).executeAsync();
        } catch (Exception e) {
            throw new CompletionException(e);
        }
    }
     ...
     * @return    Returns the GetInvoiceResponse response from the API call
     */
    public CompletableFuture<GetInvoiceResponse> updateInvoiceStatusAsync(
            final String invoiceId,
            final UpdateInvoiceStatusRequest request,
            final String idempotencyKey) {
        try {
            return prepareUpdateInvoiceStatusRequest(invoiceId, request, idempotencyKey).executeAsync();
        } catch (Exception e) {
            throw new CompletionException(e);
        }
    }
