...
|  --- | --- | --- | --- | --- | --- |
| `Installments` | `Integer` | Optional | Number of installments<br><br>**Default**: `1` | Integer getInstallments() | setInstallments(Integer installments) |
...
| `Capture` | `Boolean` | Optional | Indicates if the operation should be only authorization or auth and capture.<br><br>**Default**: `true` | Boolean getCapture() | setCapture(Boolean capture) |
...
CreateCreditCardPaymentRequest createCreditCardPaymentRequest = new CreateCreditCardPaymentRequest.Builder()
    .installments(1)
