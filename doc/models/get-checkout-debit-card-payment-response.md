...
```java
import me.pagar.api.models.GetCheckoutDebitCardPaymentResponse;

GetCheckoutDebitCardPaymentResponse getCheckoutDebitCardPaymentResponse = new GetCheckoutDebitCardPaymentResponse.Builder()
