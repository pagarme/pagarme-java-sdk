...
import me.pagar.api.models.CreateSubscriptionSplitRequest;

CreateSubscriptionSplitRequest createSubscriptionSplitRequest = new CreateSubscriptionSplitRequest.Builder(
    false,
    Arrays.asList(
        null
    )
